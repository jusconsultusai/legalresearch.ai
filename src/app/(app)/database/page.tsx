...
export default function DatabasePage() {
  ...
  const [aiResult, setAiResult] = useState<{ answer: string; sources: { title: string; number?: string; category: string; score: number }[]; subQueries?: string[] } | null>(null);
                ...
                <>
                  ...
                  {aiResult.sources && aiResult.sources.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {aiResult.sources.slice(0, 6).map((s, i) => (
                          <span key={i} className={cn(
                            "inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border",
                            s.category === "supreme_court"
                              ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700/30"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-start gap-1.5 flex-1">
                      ...
                      <p className="text-[9px] text-amber-700 dark:text-amber-400">AI analysis for informational purposes only. Not legal advice.</p>
                    </div>
                  </div>
                </>
              )}
