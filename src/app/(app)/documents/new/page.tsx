...
const DOCUMENT_CATEGORIES = [
  ...
  },
  {
    ...
    types: [
      { key: "affidavit", label: "Affidavit (General)" },
      { key: "affidavit-loss", label: "Affidavit of Loss" },
      { key: "affidavit-desistance", label: "Affidavit of Desistance" },
      { key: "affidavit-support", label: "Affidavit of Support/Guarantee" },
      { key: "affidavit-consent", label: "Affidavit of Consent" },
      { key: "affidavit-cohabitation", label: "Affidavit of Cohabitation" },
      { key: "affidavit-discrepancy", label: "Affidavit of Discrepancy" },
      { key: "affidavit-no-income", label: "Affidavit of No Income" },
      { key: "affidavit-undertaking", label: "Affidavit of Undertaking" },
      { key: "affidavit-self-adjudication", label: "Affidavit of Self-Adjudication" },
      { key: "joint-affidavit", label: "Joint Affidavit (Two Disinterested Persons)" },
