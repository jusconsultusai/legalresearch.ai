...
export const PLANS = {
  free: {
    ...
    price: 0,
    searches: 15,
    features: ["15 AI searches/month", "Basic legal database", "1 document draft/month"],
  },
  pro: {
    label: "Professional",
    price: 888,
    searches: 500,
    features: ["500 AI searches/month", "Full legal database", "Unlimited documents", "Document analysis", "Priority support"],
  },
  team: {
    label: "Team",
    price: 2999,
    searches: 2000,
    features: ["2000 AI searches/month", "Full legal database", "Real-time collaboration", "Organization workspace", "Team management", "Priority support"],
  },
  enterprise: {
    label: "Large Firms",
    price: -1,
